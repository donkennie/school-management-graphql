...
namespace school_management_graphql.Migrations
{
    ...
    [Migration("20250317193307_restore-nullable")]
    partial class restorenullable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("school_management_graphql.Models.Classroom", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("school_management_graphql.Models.Course", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("school_management_graphql.Models.Department", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("school_management_graphql.Models.Equipment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("school_management_graphql.Models.Furniture", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("school_management_graphql.Models.Group", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("school_management_graphql.Models.LabRoom", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("school_management_graphql.Models.Student", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("school_management_graphql.Models.StudentCourse", b =>
                {
            ...
            modelBuilder.Entity("school_management_graphql.Models.Teacher", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("school_management_graphql.Models.TeacherCourse", b =>
                {
                    b.Property<Guid>("CourseId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("school_management_graphql.Models.Course", b =>
                {
                    b.HasOne("school_management_graphql.Models.Department", "Department")
                        .WithMany("Courses")
            ...
            modelBuilder.Entity("school_management_graphql.Models.Student", b =>
                {
                    b.HasOne("school_management_graphql.Models.Group", "Group")
                        .WithMany("Students")
            ...
            modelBuilder.Entity("school_management_graphql.Models.StudentCourse", b =>
                {
                    b.HasOne("school_management_graphql.Models.Course", null)
                        .WithMany("StudentCourses")
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("school_management_graphql.Models.Student", null)
                        .WithMany("StudentCourses")
            ...
            modelBuilder.Entity("school_management_graphql.Models.TeacherCourse", b =>
                {
                    ...
                    b.HasOne("school_management_graphql.Models.Teacher", null)
                        .WithMany("TeacherCourses")
